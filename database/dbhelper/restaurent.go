...
func GetRestaurentById(restaurantId string) (models.Restaurant, error) {
...
func IsRestaurentExists(name, addressline string) (bool, error) {
...
func CreateRestaurentHelper(name string, addressline string, latitude float64, longitude float64, createdBy string) (string, error) {
...
func GetRestaurentHelper() ([]models.Restaurant, error) {
